...
class instruction_graph_generator {
  public:
	...
	explicit instruction_graph_generator(size_t num_nodes, node_id local_nid, const system_info& system, instruction_graph& idag, delegate* dlg = nullptr,
	    instruction_recorder* recorder = nullptr, const policy_set& policy = default_policy_set());
