...
#define CELERITY_WORKAROUND_VERSION_MAJOR SIMSYCL_VERSION_MAJOR
#define CELERITY_WORKAROUND_VERSION_MINOR SIMSYCL_VERSION_MINOR
#define CELERITY_WORKAROUND_VERSION_PATCH SIMSYCL_VERSION_PATCH
#else
