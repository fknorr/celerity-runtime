...
namespace detail {
	...
	class task_manager {
	  ...
	  private:
		...
		inline bool need_new_horizon() const { return max_pseudo_critical_path_length - emerging_horizon_critical_path_length >= task_horizon_step_size; }
