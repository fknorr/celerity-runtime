...
template <int Dims>
class dim_device_queue_fixture : public test_utils::local_devices_fixture {};
...
TEST_CASE_METHOD(test_utils::local_devices_fixture, "SYCL has working simple scalar reductions", "[sycl][reductions]") {
	...
	get_default_device_queue().get_sycl_queue().submit([&](sycl::handler& cgh) {
