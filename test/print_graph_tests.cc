...
TEST_CASE("instruction-graph printing is unchanged", "[print_graph][instruction-graph]") {
	...
	const std::string expected =
	    ...
	    "C0)<br/><b>epoch</b>>];I1[color=cyan3,shape=ellipse,label=<I1<br/>buffer <b>alloc</b> M1.A1<br/>for B1 [0,0,0] - [8,1,1]<br/>32%4 "
	    "bytes>];I2[color=green3,shape=ellipse,label=<I2<br/><b>init buffer</b> B1<br/>via M1.A1, 32 bytes>];I3[color=cyan3,shape=ellipse,label=<I3<br/>buffer "
	    "<b>alloc</b> M1.A2<br/>for B0 [0,0,0] - [1,1,1]<br/>4%4 bytes>];I4[color=cyan3,shape=ellipse,label=<I4<br/>buffer <b>alloc</b> M3.A1<br/>for B0 "
	    "[0,0,0] - [1,1,1]<br/>4%4 bytes>];I5[color=cyan3,shape=ellipse,label=<I5<br/>buffer <b>alloc</b> M2.A1<br/>for B0 [0,0,0] - [1,1,1]<br/>4%4 "
	    "bytes>];I6[color=cyan3,shape=ellipse,label=<I6<br/>buffer <b>alloc</b> M3.A2<br/>for B1 [1,0,0] - [2,1,1]<br/>4%4 "
	    "bytes>];I7[color=cyan3,shape=ellipse,label=<I7<br/>buffer <b>alloc</b> M2.A2<br/>for B1 [0,0,0] - [1,1,1]<br/>4%4 "
	    "bytes>];I8[color=green3,shape=ellipse,label=<I8<br/>coherence <b>copy</b><br/>on B1 [1,0,0] - [2,1,1]<br/>from M1.A1 [1,0,0] - [2,1,1]<br/>to M3.A2 "
	    "[0,0,0] - [1,1,1]<br/>[1,1,1]x4 bytes>];I9[color=green3,shape=ellipse,label=<I9<br/>coherence <b>copy</b><br/>on B1 [0,0,0] - [1,1,1]<br/>from M1.A1 "
	    "[0,0,0] - [1,1,1]<br/>to M2.A2 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 bytes>];I10[color=cyan3,shape=ellipse,label=<I10<br/>gather <b>alloc</b> M1.A3<br/>for "
	    "B0 [0,0,0] - [1,1,1] x2<br/>8%4 bytes>];I11[color=darkorange2,shape=box,margin=0.2,style=rounded,label=<I11 (device-compute T1, execution "
	    "C1)<br/><b>device kernel</b><br/>on D0 [0,0,0] + [1,1,1]<br/>+ access B1 [0,0,0] - [1,1,1]<br/>via M2.A2 [0,0,0] - [1,1,1]<br/>+ (R1) reduce into B0 "
	    "[0,0,0] - [1,1,1]<br/>via M2.A1 [0,0,0] - [1,1,1]>];I12[color=darkorange2,shape=box,margin=0.2,style=rounded,label=<I12 (device-compute T1, execution "
	    "C1)<br/><b>device kernel</b><br/>on D1 [1,0,0] + [1,1,1]<br/>+ access B1 [1,0,0] - [2,1,1]<br/>via M3.A2 [0,0,0] - [1,1,1]<br/>+ (R1) reduce into B0 "
	    "[0,0,0] - [1,1,1]<br/>via M3.A1 [0,0,0] - [1,1,1]>];I13[color=green3,shape=ellipse,label=<I13<br/>gather <b>copy</b><br/>on B0 [0,0,0] - "
	    "[1,1,1]<br/>from M2.A1 [0,0,0] - [1,1,1]<br/>to M1.A3 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 bytes>];I14[color=green3,shape=ellipse,label=<I14<br/>gather "
	    "<b>copy</b><br/>on B0 [0,0,0] - [1,1,1]<br/>from M3.A1 [0,0,0] - [1,1,1]<br/>to M1.A3 [1,0,0] - [2,1,1]<br/>[1,1,1]x4 "
	    "bytes>];I15[color=blue,shape=ellipse,label=<I15<br/>local <b>reduce</b> B0.R1<br/>B0 [0,0,0] - [1,1,1]<br/>from M1.A3 x2<br/>to M1.A2 "
	    "x1>];I16[color=cyan3,shape=ellipse,label=<I16<br/><b>free</b> M1.A3 <br/>8 bytes>];I17[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I17 "
	    "(push C5)<br/><b>send</b> T2.B0.R1<br/>to N1 tag 10<br/>B0 [0,0,0] - [1,1,1]<br/>via M1.A2 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 "
	    "bytes>];I18[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I18 (push C6)<br/><b>send</b> T2.B0.R1<br/>to N2 tag 11<br/>B0 [0,0,0] - "
	    "[1,1,1]<br/>via M1.A2 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 bytes>];I19[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I19 (push "
	    "C7)<br/><b>send</b> T2.B0.R1<br/>to N3 tag 12<br/>B0 [0,0,0] - [1,1,1]<br/>via M1.A2 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 "
	    "bytes>];I20[color=cyan3,shape=ellipse,label=<I20<br/>gather <b>alloc</b> M1.A4<br/>for B0 [0,0,0] - [1,1,1] x4<br/>16%4 "
	    "bytes>];I21[color=blue,shape=ellipse,label=<I21<br/><b>fill identity</b> for R1<br/>M1.A4 x4>];I22[color=green3,shape=ellipse,label=<I22<br/>gather "
	    "<b>copy</b><br/>on B0 [0,0,0] - [1,1,1]<br/>from M1.A2 [0,0,0] - [1,1,1]<br/>to M1.A4 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 "
	    "bytes>];I23[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I23 (await-push C4)<br/><b>gather receive</b> T2.B0.R1<br/>B0 [0,0,0] - [1,1,1] "
	    "x4<br/>into M1.A4>];I24[color=blue,shape=box,margin=0.2,style=rounded,label=<I24 (reduction C3)<br/>global <b>reduce</b> B0.R1<br/>B0 [0,0,0] - "
	    "[1,1,1]<br/>from M1.A4 x4<br/>to M1.A2 x1>];I25[color=cyan3,shape=ellipse,label=<I25<br/><b>free</b> M1.A4 <br/>16 "
	    "bytes>];I26[color=green3,shape=ellipse,label=<I26<br/><b>export</b><br/>B0 [0,0,0] - [1,1,1]<br/>via M1.A2 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 "
	    "bytes>];I27[color=darkorange,shape=box,margin=0.2,style=rounded,label=<I27 (T2, C2)<br/><b>fence</b><br/>B0 [0,0,0] - "
	    "[1,1,1]>];I28[color=cyan3,shape=ellipse,label=<I28<br/><b>free</b> M1.A1<br/>B1 [0,0,0] - [8,1,1] <br/>32 "
	    "bytes>];I29[color=cyan3,shape=ellipse,label=<I29<br/><b>free</b> M2.A2<br/>B1 [0,0,0] - [1,1,1] <br/>4 "
	    "bytes>];I30[color=cyan3,shape=ellipse,label=<I30<br/><b>free</b> M3.A2<br/>B1 [1,0,0] - [2,1,1] <br/>4 "
	    "bytes>];I31[color=cyan3,shape=ellipse,label=<I31<br/><b>free</b> M1.A2<br/>B0 [0,0,0] - [1,1,1] <br/>4 "
	    "bytes>];I32[color=cyan3,shape=ellipse,label=<I32<br/><b>free</b> M2.A1<br/>B0 [0,0,0] - [1,1,1] <br/>4 "
	    "bytes>];I33[color=cyan3,shape=ellipse,label=<I33<br/><b>free</b> M3.A1<br/>B0 [0,0,0] - [1,1,1] <br/>4 "
	    "bytes>];I34[color=black,shape=box,margin=0.2,style=rounded,label=<I34 (T3, C8)<br/><b>epoch</b> (shutdown)<br/>drop "
	    "R1>];I0->I1[];I1->I2[];I0->I3[];I0->I4[];I0->I5[];I0->I6[];I0->I7[];I2->I8[];I6->I8[];I2->I9[];I7->I9[];I0->I10[];I9->I11[];I5->I11[];I8->I12[];I4->"
	    "I12[];I10->I13[];I11->I13[];I10->I14[];I12->I14[];I13->I15[];I14->I15[];I3->I15[];I15->I16[];I15->I17[];I15->I18[];I15->I19[];I0->I20[];I20->I21[];"
	    "I21->I22[];I15->I22[];I21->I23[];I23->I24[];I22->I24[];I17->I24[];I18->I24[];I19->I24[];I24->I25[];I24->I26[];I26->I27[];I9->I28[];I2->I28[];I8->I28[]"
	    ";I11->I29[];I12->I30[];I26->I31[];I13->I32[];I14->I33[];I33->I34[];I32->I34[];I31->I34[];I30->I34[];I28->I34[];I27->I34[];I25->I34[];I29->I34[];I16->"
	    "I34[];P10[margin=0.2,shape=cds,color=\"#606060\",label=<<font color=\"#606060\"><b>pilot</b> to N1 tag 10<br/>T2.B0.R1<br/>for B0 [0,0,0] - "
...
TEST_CASE_METHOD(test_utils::runtime_fixture, "full graph is printed if CELERITY_RECORDING is set", "[print_graph]") {
	...
	SECTION("instruction graph") {
		const auto* expected =
		    ...
		    "cyan3,shape=ellipse,label=<I1<br/>buffer <b>alloc</b> M1.A1<br/>for B0 [0,0,0] - [16,1,1]<br/>64%4 "
		    "bytes>];I2[color=green3,shape=ellipse,label=<I2<br/><b>init buffer</b> B0<br/>via M1.A1, 64 "
		    ...
		    "[0,0,0] + [16,1,1]<br/>+ access B0 [0,0,0] - [16,1,1]<br/>via M1.A1 [0,0,0] - "
