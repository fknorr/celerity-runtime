...
TEST_CASE("instruction-graph printing is unchanged", "[print_graph][instruction-graph]") {
	...
	const std::string expected =
	    ...
	    "bytes>];I8[color=green3,shape=ellipse,label=<I8<br/>1D coherence <b>copy</b><br/>on B1 [1,0,0] - [2,1,1]<br/>from M1.A1 [1,0,0] - [2,1,1]<br/>to "
	    "M3.A2 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 bytes>];I9[color=green3,shape=ellipse,label=<I9<br/>1D coherence <b>copy</b><br/>on B1 [0,0,0] - "
	    "[1,1,1]<br/>from M1.A1 [0,0,0] - [1,1,1]<br/>to M2.A2 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 bytes>];I10[color=cyan3,shape=ellipse,label=<I10<br/>gather "
	    "<b>alloc</b> M1.A3<br/>for B0 [0,0,0] - [1,1,1] x2<br/>8%4 bytes>];I11[color=darkorange2,shape=box,margin=0.2,style=rounded,label=<I11 "
	    "(device-compute T1, execution C1)<br/><b>device kernel</b><br/>on D0 [0,0,0] + [1,1,1]<br/>+ access B1 [0,0,0] - [1,1,1]<br/>via M2.A2 [0,0,0] - "
	    ...
	    "- [1,1,1]>];I13[color=green3,shape=ellipse,label=<I13<br/>1D gather <b>copy</b><br/>on B0 [0,0,0] - [1,1,1]<br/>from M2.A1 [0,0,0] - [1,1,1]<br/>to "
	    "M1.A3 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 bytes>];I14[color=green3,shape=ellipse,label=<I14<br/>1D gather <b>copy</b><br/>on B0 [0,0,0] - "
	    "[1,1,1]<br/>from M3.A1 [0,0,0] - [1,1,1]<br/>to M1.A3 [1,0,0] - [2,1,1]<br/>[1,1,1]x4 bytes>];I15[color=blue,shape=ellipse,label=<I15<br/>local "
	    "<b>reduce</b> B0.R1<br/>B0 [0,0,0] - [1,1,1]<br/>from M1.A3 x2<br/>to M1.A2 x1>];I16[color=cyan3,shape=ellipse,label=<I16<br/><b>free</b> M1.A3 "
	    ...
	    "[1,1,1]<br/>via M1.A2 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 bytes>];I18[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I18 (push "
	    "C6)<br/><b>send</b> T2.B0.R1<br/>to N2 tag 11<br/>B0 [0,0,0] - [1,1,1]<br/>via M1.A2 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 "
	    ...
	    "[1,1,1]<br/>via M1.A2 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 bytes>];I20[color=cyan3,shape=ellipse,label=<I20<br/>gather <b>alloc</b> M1.A4<br/>for B0 "
	    "[0,0,0] - [1,1,1] x4<br/>16%4 bytes>];I21[color=blue,shape=ellipse,label=<I21<br/><b>fill identity</b> for R1<br/>M1.A4 "
	    "x4>];I22[color=green3,shape=ellipse,label=<I22<br/>1D gather <b>copy</b><br/>on B0 [0,0,0] - [1,1,1]<br/>from M1.A2 [0,0,0] - [1,1,1]<br/>to M1.A4 "
	    ...
	    "T2.B0.R1<br/>B0 [0,0,0] - [1,1,1] x4<br/>into M1.A4>];I24[color=blue,shape=box,margin=0.2,style=rounded,label=<I24 (reduction C3)<br/>global "
	    "<b>reduce</b> B0.R1<br/>B0 [0,0,0] - [1,1,1]<br/>from M1.A4 x4<br/>to M1.A2 x1>];I25[color=cyan3,shape=ellipse,label=<I25<br/><b>free</b> M1.A4 "
	    "<br/>16 bytes>];I26[color=green3,shape=ellipse,label=<I26<br/>1D <b>export</b><br/>B0 [0,0,0] - [1,1,1]<br/>via M1.A2 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 "
