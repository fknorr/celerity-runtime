...
TEST_CASE("instruction-graph printing is unchanged", "[print_graph][instruction-graph]") {
	...
	const std::string expected =
	    ...
	    "bytes>];I8[color=green3,shape=ellipse,label=<I8<br/>coherence <b>copy</b><br/>from M1.A1 ([0,0,0] - [8,1,1])<br/>to M3.A2 ([1,0,0] - [2,1,1])<br/>B1 "
	    "{[1,0,0] - [2,1,1]} x4 bytes>];I9[color=green3,shape=ellipse,label=<I9<br/>coherence <b>copy</b><br/>from M1.A1 ([0,0,0] - [8,1,1])<br/>to M2.A2 "
	    "([0,0,0] - [1,1,1])<br/>B1 {[0,0,0] - [1,1,1]} x4 bytes>];I10[color=cyan3,shape=ellipse,label=<I10<br/>gather <b>alloc</b> M1.A3<br/>for B0 [0,0,0] - "
	    "[1,1,1] x2<br/>8%4 bytes>];I11[color=darkorange2,shape=box,margin=0.2,style=rounded,label=<I11 (device-compute T1, execution C1)<br/><b>device "
	    "kernel</b><br/>on D0 [0,0,0] + [1,1,1]<br/>+ access B1 [0,0,0] - [1,1,1]<br/>via M2.A2 [0,0,0] - [1,1,1]<br/>+ (R1) reduce into B0 [0,0,0] - "
	    "[1,1,1]<br/>via M2.A1 [0,0,0] - [1,1,1]>];I12[color=darkorange2,shape=box,margin=0.2,style=rounded,label=<I12 (device-compute T1, execution "
	    "C1)<br/><b>device kernel</b><br/>on D1 [1,0,0] + [1,1,1]<br/>+ access B1 [1,0,0] - [2,1,1]<br/>via M3.A2 [0,0,0] - [1,1,1]<br/>+ (R1) reduce into B0 "
	    "[0,0,0] - [1,1,1]<br/>via M3.A1 [0,0,0] - [1,1,1]>];I13[color=green3,shape=ellipse,label=<I13<br/>gather <b>copy</b><br/>from M2.A1 ([0,0,0] - "
	    "[1,1,1])<br/>to M1.A3 ([0,0,0] - [1,1,1])<br/>B0 {[0,0,0] - [1,1,1]} x4 bytes>];I14[color=green3,shape=ellipse,label=<I14<br/>gather "
	    "<b>copy</b><br/>from M3.A1 ([0,0,0] - [1,1,1])<br/>to M1.A3 + 4 bytes ([0,0,0] - [1,1,1])<br/>B0 {[0,0,0] - [1,1,1]} x4 "
	    ...
	    "<b>copy</b><br/>from M1.A2 ([0,0,0] - [1,1,1])<br/>to M1.A4 ([0,0,0] - [1,1,1])<br/>B0 {[0,0,0] - [1,1,1]} x4 "
