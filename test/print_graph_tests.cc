...
TEST_CASE("instruction-graph printing is unchanged", "[print_graph][instruction-graph]") {
	...
	const std::string expected =
	    ...
	    "[2,0,0] - [3,1,1]<br/>+ access B1 {[2,0,0] - [3,1,1]}<br/>via M2.A2 [0,0,0] - [1,1,1]<br/>+ (R1) reduce into B0 [0,0,0] - [1,1,1]<br/>via M2.A1 "
	    "[0,0,0] - [1,1,1]>];I13[color=darkorange2,shape=box,margin=0.2,style=rounded,label=<I13 (device-compute T1, execution C1)<br/><b>device "
	    "kernel</b><br/>on D1 [3,0,0] - [4,1,1]<br/>+ access B1 {[3,0,0] - [4,1,1]}<br/>via M3.A2 [0,0,0] - [1,1,1]<br/>+ (R1) reduce into B0 [0,0,0] - "
	    "[1,1,1]<br/>via M3.A1 [0,0,0] - [1,1,1]>];I14[color=green3,shape=ellipse,label=<I14<br/>gather <b>copy</b><br/>from M2.A1 ([0,0,0] - [1,1,1])<br/>to "
	    "M1.A3 ([0,0,0] - [1,1,1])<br/>B0 {[0,0,0] - [1,1,1]} x4 bytes>];I15[color=green3,shape=ellipse,label=<I15<br/>gather <b>copy</b><br/>from M3.A1 "
	    "([0,0,0] - [1,1,1])<br/>to M1.A3 + 4 bytes ([0,0,0] - [1,1,1])<br/>B0 {[0,0,0] - [1,1,1]} x4 "
	    "bytes>];I16[color=blue,shape=ellipse,label=<I16<br/>local <b>reduce</b> B0.R1<br/>B0 [0,0,0] - [1,1,1]<br/>from M1.A3 x2<br/>to M1.A1 "
	    "x1>];I17[color=cyan3,shape=ellipse,label=<I17<br/><b>free</b> M1.A3 <br/>8 bytes>];I18[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I18 "
	    "(push C2)<br/><b>send</b> T2.B0.R1<br/>to N0 MSG0<br/>B0 [0,0,0] - [1,1,1]<br/>via M1.A1 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 "
	    "bytes>];I19[color=green3,shape=ellipse,label=<I19<br/>coherence <b>copy</b><br/>from M2.A2 ([2,0,0] - [3,1,1])<br/>to M1.A2 ([2,0,0] - "
	    "[4,1,1])<br/>B1 {[2,0,0] - [3,1,1]} x4 bytes>];I20[color=green3,shape=ellipse,label=<I20<br/>coherence <b>copy</b><br/>from M3.A2 ([3,0,0] - "
	    "[4,1,1])<br/>to M1.A2 ([2,0,0] - [4,1,1])<br/>B1 {[3,0,0] - [4,1,1]} x4 bytes>];I21[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I21 "
	    "(push C3)<br/><b>send</b> T2.B1<br/>to N0 MSG1<br/>B1 [2,0,0] - [3,1,1]<br/>via M1.A2 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 "
	    "bytes>];I22[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I22 (push C3)<br/><b>send</b> T2.B1<br/>to N0 MSG2<br/>B1 [3,0,0] - "
	    "[4,1,1]<br/>via M1.A2 [1,0,0] - [2,1,1]<br/>[1,1,1]x4 bytes>];I23[color=cyan3,shape=ellipse,label=<I23<br/>gather <b>alloc</b> M1.A4<br/>for B0 "
	    "[0,0,0] - [1,1,1] x2<br/>8%4 bytes>];I24[color=blue,shape=ellipse,label=<I24<br/><b>fill identity</b> for R1<br/>M1.A4 "
	    "x2>];I25[color=green3,shape=ellipse,label=<I25<br/>gather <b>copy</b><br/>from M1.A1 ([0,0,0] - [1,1,1])<br/>to M1.A4 + 4 bytes ([0,0,0] - "
	    "[1,1,1])<br/>B0 {[0,0,0] - [1,1,1]} x4 bytes>];I26[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I26 (await-push C6)<br/><b>gather "
	    "receive</b> T2.B0.R1<br/>B0 [0,0,0] - [1,1,1] x2<br/>into M1.A4>];I27[color=blue,shape=box,margin=0.2,style=rounded,label=<I27 (reduction "
	    "C5)<br/>global <b>reduce</b> B0.R1<br/>B0 [0,0,0] - [1,1,1]<br/>from M1.A4 x2<br/>to M1.A1 "
	    "x1>];I28[color=cyan3,shape=ellipse,label=<I28<br/><b>free</b> M1.A4 <br/>8 bytes>];I29[color=cyan3,shape=ellipse,label=<I29<br/>buffer <b>alloc</b> "
	    "M1.A5<br/>for B1 [0,0,0] - [2,1,1]<br/>8%4 bytes>];I30[color=cyan3,shape=ellipse,label=<I30<br/>buffer <b>alloc</b> M2.A3<br/>for B1 [1,0,0] - "
	    "[2,1,1]<br/>4%4 bytes>];I31[color=cyan3,shape=ellipse,label=<I31<br/>buffer <b>alloc</b> M3.A3<br/>for B1 [0,0,0] - [1,1,1]<br/>4%4 "
	    ...
	    "[1,1,1]<br/>+ access B1 {[1,0,0] - [2,1,1]}<br/>via M2.A3 [0,0,0] - [1,1,1]<br/>+ access B2 {}<br/>via null [0,0,0] - "
	    ...
	    "[1,1,1]<br/>+ access B2 {}<br/>via null [0,0,0] - [0,0,0]>];I41[color=black,shape=box,margin=0.2,style=rounded,label=<I41 (T3, "
	    ...
	    "[1,1,1]<br/>+ access B2 {[0,0,0] - [1,1,1]}<br/>via M1.A6 [0,0,0] - [1,1,1]>];I46[color=green3,shape=ellipse,label=<I46<br/>fence "
	    "<b>copy</b><br/>from M1.A1 ([0,0,0] - [1,1,1])<br/>to M0.A4 ([0,0,0] - [1,1,1])<br/>B0 {[0,0,0] - [1,1,1]} x4 "
