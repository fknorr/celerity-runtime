...
TEST_CASE("command-graph printing is unchanged", "[print_graph][command-graph]") {
	...
	const std::string expected =
	    ...
	    "id_0_2->id_0_4[color=limegreen];id_0_3->id_0_4[];id_0_4->id_0_5[];id_0_5->id_0_6[];id_0_5->id_0_8[];id_0_5->id_0_9[];id_0_5->id_0_11[];id_0_6->id_0_"
	    "10[color=orange];id_0_7->id_0_8[];id_0_7->id_0_9[];id_0_7->id_0_11[];id_0_8->id_0_9[color=blue];id_0_9->id_0_10[color=orange];}";
...
TEST_CASE("instruction-graph printing is unchanged", "[print_graph][instruction-graph]") {
	...
	const std::string expected =
	    ...
	    "[1,1,1]<br/>via M1.A1 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 bytes<br/>4 bytes total>];I19[color=cyan3,shape=ellipse,label=<I19<br/>gather <b>alloc</b> "
	    "M1.A4<br/>for B0 [0,0,0] - [1,1,1] x2<br/>8 % 4 bytes>];I20[color=blue,shape=ellipse,label=<I20<br/><b>fill identity</b> for R1<br/>M1.A4 "
	    "x2>];I21[color=green3,shape=ellipse,margin=0,label=<I21<br/>gather <b>copy</b><br/>from M1.A1 ([0,0,0] - [1,1,1])<br/>to M1.A4 +4 bytes<br/>B0 "
	    "{[0,0,0] - [1,1,1]} x4 bytes<br/>4 bytes total>];I22[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I22 (await-push C3)<br/><b>gather "
	    "receive</b> T2.B0.R1<br/>B0 [0,0,0] - [1,1,1] x2<br/>into M1.A4>];I23[color=blue,shape=box,margin=0.2,style=rounded,label=<I23 (reduction "
	    "C4)<br/>global <b>reduce</b> B0.R1<br/>B0 [0,0,0] - [1,1,1]<br/>from M1.A4 x2<br/>to M1.A1 "
	    "x1>];I24[color=cyan3,shape=ellipse,label=<I24<br/><b>free</b> M1.A4 <br/>8 bytes>];I25[color=cyan3,shape=ellipse,label=<I25<br/>buffer <b>alloc</b> "
	    "M1.A5<br/>for B1 [2,0,0] - [4,1,1]<br/>8 % 4 bytes>];I26[color=green3,shape=ellipse,margin=0,label=<I26<br/>coherence <b>copy</b><br/>from M3.A2 "
	    "([3,0,0] - [4,1,1])<br/>to M1.A5 ([2,0,0] - [4,1,1])<br/>B1 {[3,0,0] - [4,1,1]} x4 bytes<br/>4 bytes "
	    "total>];I27[color=green3,shape=ellipse,margin=0,label=<I27<br/>coherence <b>copy</b><br/>from M2.A2 ([2,0,0] - [3,1,1])<br/>to M1.A5 ([2,0,0] - "
	    "[4,1,1])<br/>B1 {[2,0,0] - [3,1,1]} x4 bytes<br/>4 bytes total>];I28[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I28 (push "
	    "C5)<br/><b>send</b> T2.B1<br/>to N0 MSG1<br/>B1 [2,0,0] - [3,1,1]<br/>via M1.A5 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 bytes<br/>4 bytes "
	    "total>];I29[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I29 (push C5)<br/><b>send</b> T2.B1<br/>to N0 MSG2<br/>B1 [3,0,0] - "
	    "[4,1,1]<br/>via M1.A5 [1,0,0] - [2,1,1]<br/>[1,1,1]x4 bytes<br/>4 bytes total>];I30[color=cyan3,shape=ellipse,label=<I30<br/>buffer <b>alloc</b> "
	    ...
	    "bytes>];I33[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I33 (await-push C6)<br/><b>split receive</b> T2.B1<br/>B1 {[0,0,0] - "
	    ...
	    "(await-push C6)<br/><b>await receive</b> T2.B1<br/>B1 {[1,0,0] - [2,1,1]}>];I35[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I35 "
	    "(await-push C6)<br/><b>await receive</b> T2.B1<br/>B1 {[0,0,0] - [1,1,1]}>];I36[color=green3,shape=ellipse,margin=0,label=<I36<br/>coherence "
	    ...
	    "T2, execution C7)<br/><b>device kernel</b><br/>on D0 [2,0,0] - [3,1,1]<br/>+ access B0 [0,0,0] - [1,1,1]<br/>via M2.A1 [0,0,0] - [1,1,1]<br/>+ access "
	    "B1 [1,0,0] - [2,1,1]<br/>via M2.A3 [0,0,0] - [1,1,1]<br/>+ access B2 [0,0,0] - [0,0,0]<br/>via null [0,0,0] - "
	    "[0,0,0]>];I41[color=darkorange2,shape=box,margin=0.2,style=rounded,label=<I41 (device-compute T2, execution C7)<br/><b>device kernel</b><br/>on D1 "
	    ...
	    "bytes>];I45[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I45 (await-push C9)<br/><b>receive</b> T4.B2<br/>B2 {[0,0,0] - "
	    ...
	    "(CG2 collective-host T4, execution C10)<br/><b>host task</b><br/>on host [1,0,0] - [2,1,1]<br/>+ access B0 [0,0,0] - [1,1,1]<br/>via M1.A1 [0,0,0] - "
	    ...
	    "bytes>];I52[color=cyan3,shape=ellipse,label=<I52<br/><b>free</b> M1.A5<br/>B1 [2,0,0] - [4,1,1] <br/>8 "
	    ...
	    "];I0->I11[color=orchid];I0->I19[color=orchid];I0->I25[color=orchid];I0->I30[color=orchid];I0->I31[color=orchid];I0->I32[color=orchid];I0->I43[color="
	    ...
	    "color=cyan3];I12->I14[];I12->I27[];I13->I15[];I13->I26[];I14->I16[];I14->I39[color=limegreen];I15->I16[];I15->I38[color=limegreen];I16->I17[color="
	    "cyan3];I16->I18[];I16->I21[];I17->I42[color=orange];I18->I23[color=limegreen];I19->I20[color=cyan3];I20->I21[color=limegreen];I20->I22[color="
	    "limegreen];I21->I23[];I22->I23[];I23->I24[color=cyan3];I23->I38[];I23->I39[];I23->I46[];I23->I47[];I24->I42[color=orange];I25->I26[color=cyan3];I25->"
	    "I27[color=cyan3];I26->I29[];I26->I56[color=cyan3];I27->I28[];I27->I54[color=cyan3];I28->I42[color=orange];I28->I52[color=cyan3];I29->I42[color=orange]"
	    ";I29->I52[color=cyan3];I30->I33[color=cyan3];I31->I37[color=cyan3];I32->I36[color=cyan3];I33->I34[color=gray];I33->I35[color=gray];I34->I37[];I35->"
	    ...
	    "[3,1,1]</font>>];P1->I28[dir=none,style=dashed,color=\"#606060\"];P2[margin=0.25,shape=cds,color=\"#606060\",label=<<font "
	    "color=\"#606060\"><b>pilot</b> to N0 MSG2<br/>T2.B1<br/>for B1 [3,0,0] - [4,1,1]</font>>];P2->I29[dir=none,style=dashed,color=\"#606060\"];}";
