...
TEST_CASE("instruction-graph printing is unchanged", "[print_graph][instruction-graph]") {
	...
	const std::string expected =
	    ...
	    "bytes>];I4[color=cyan3,shape=ellipse,label=<I4<br/>buffer <b>alloc</b> M1.A2<br/>for B1 [0,0,0] - [2,1,1]<br/>8%4 "
	    ...
	    "{[0,0,0] - [1,1,1]} x4 bytes>];I8[color=green3,shape=ellipse,label=<I8<br/>coherence <b>copy</b><br/>from M0.A1 ([0,0,0] - [8,1,1])<br/>to M1.A2 "
	    "([0,0,0] - [2,1,1])<br/>B1 {[1,0,0] - [2,1,1]} x4 bytes>];I9[color=green3,shape=ellipse,label=<I9<br/>coherence <b>copy</b><br/>from M1.A2 ([0,0,0] - "
	    "[2,1,1])<br/>to M2.A2 ([0,0,0] - [1,1,1])<br/>B1 {[0,0,0] - [1,1,1]} x4 bytes>];I10[color=green3,shape=ellipse,label=<I10<br/>coherence "
	    "<b>copy</b><br/>from M1.A2 ([0,0,0] - [2,1,1])<br/>to M3.A2 ([1,0,0] - [2,1,1])<br/>B1 {[1,0,0] - [2,1,1]} x4 "
	    ...
	    "[1,0,0] - [2,1,1]<br/>+ access B1 [1,0,0] - [2,1,1]<br/>via M3.A2 [0,0,0] - [1,1,1]<br/>+ (R1) reduce into B0 [0,0,0] - [1,1,1]<br/>via M3.A1 [0,0,0] "
	    ...
	    "];I0->I11[color=orchid];I0->I21[color=orchid];I1->I16[color=cyan3];I2->I12[color=cyan3];I3->I13[color=cyan3];I4->I7[color=cyan3];I4->I8[color=cyan3];"
	    "I5->I9[color=cyan3];I6->I10[color=cyan3];I7->I9[];I8->I10[];I9->I12[];I9->I29[color=cyan3];I10->I13[];I10->I29[color=cyan3];I11->I14[color=cyan3];I11-"
