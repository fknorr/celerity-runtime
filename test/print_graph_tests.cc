...
TEST_CASE("instruction-graph printing is unchanged", "[print_graph][instruction-graph]") {
	...
	const std::string expected =
	    ...
	    "<b>alloc</b> M1.A2<br/>for B0 [0,0,0] - [1,1,1]<br/>4%4 bytes>];I4[color=cyan3,shape=ellipse,label=<I4<br/>buffer <b>alloc</b> M3.A3<br/>for B0 "
	    "[0,0,0] - [1,1,1]<br/>4%4 bytes>];I5[color=cyan3,shape=ellipse,label=<I5<br/>buffer <b>alloc</b> M2.A4<br/>for B0 [0,0,0] - [1,1,1]<br/>4%4 "
	    "bytes>];I6[color=cyan3,shape=ellipse,label=<I6<br/>buffer <b>alloc</b> M3.A5<br/>for B1 [1,0,0] - [2,1,1]<br/>4%4 "
	    "bytes>];I7[color=cyan3,shape=ellipse,label=<I7<br/>buffer <b>alloc</b> M2.A6<br/>for B1 [0,0,0] - [1,1,1]<br/>4%4 "
	    ...
	    "M3.A5 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 bytes>];I9[color=green3,shape=ellipse,label=<I9<br/>1D coherence <b>copy</b><br/>on B1 [0,0,0] - "
	    "[1,1,1]<br/>from M1.A1 [0,0,0] - [1,1,1]<br/>to M2.A6 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 bytes>];I10[color=cyan3,shape=ellipse,label=<I10<br/>gather "
	    "<b>alloc</b> M1.A7<br/>for B0 [0,0,0] - [1,1,1] x2<br/>8%4 bytes>];I11[color=darkorange2,shape=box,margin=0.2,style=rounded,label=<I11 "
	    "(device-compute T1, execution C1)<br/><b>device kernel</b><br/>on D0 [0,0,0] + [1,1,1]<br/>+ access B1 [0,0,0] - [1,1,1]<br/>via M2.A6 [0,0,0] - "
	    "[1,1,1]<br/>+ (R1) reduce into B0 [0,0,0] - [1,1,1]<br/>via M2.A4 [0,0,0] - "
	    ...
	    "[1,0,0] + [1,1,1]<br/>+ access B1 [1,0,0] - [2,1,1]<br/>via M3.A5 [0,0,0] - [1,1,1]<br/>+ (R1) reduce into B0 [0,0,0] - [1,1,1]<br/>via M3.A3 [0,0,0] "
	    "- [1,1,1]>];I13[color=green3,shape=ellipse,label=<I13<br/>1D gather <b>copy</b><br/>on B0 [0,0,0] - [1,1,1]<br/>from M2.A4 [0,0,0] - [1,1,1]<br/>to "
	    "M1.A7 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 bytes>];I14[color=green3,shape=ellipse,label=<I14<br/>1D gather <b>copy</b><br/>on B0 [0,0,0] - "
	    "[1,1,1]<br/>from M3.A3 [0,0,0] - [1,1,1]<br/>to M1.A7 [1,0,0] - [2,1,1]<br/>[1,1,1]x4 bytes>];I15[color=blue,shape=ellipse,label=<I15<br/>local "
	    "<b>reduce</b> B0.R1<br/>B0 [0,0,0] - [1,1,1]<br/>from M1.A7 x2<br/>to M1.A2 x1>];I16[color=cyan3,shape=ellipse,label=<I16<br/><b>free</b> M1.A7 "
	    ...
	    "[1,1,1]<br/>via M1.A2 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 bytes>];I20[color=cyan3,shape=ellipse,label=<I20<br/>gather <b>alloc</b> M1.A8<br/>for B0 "
	    "[0,0,0] - [1,1,1] x4<br/>16%4 bytes>];I21[color=blue,shape=ellipse,label=<I21<br/><b>fill identity</b> for R1<br/>M1.A8 "
	    "x4>];I22[color=green3,shape=ellipse,label=<I22<br/>1D gather <b>copy</b><br/>on B0 [0,0,0] - [1,1,1]<br/>from M1.A2 [0,0,0] - [1,1,1]<br/>to M1.A8 "
	    ...
	    "T2.B0.R1<br/>B0 [0,0,0] - [1,1,1] x4<br/>into M1.A8>];I24[color=blue,shape=box,margin=0.2,style=rounded,label=<I24 (reduction C3)<br/>global "
	    "<b>reduce</b> B0.R1<br/>B0 [0,0,0] - [1,1,1]<br/>from M1.A8 x4<br/>to M1.A2 x1>];I25[color=cyan3,shape=ellipse,label=<I25<br/><b>free</b> M1.A8 "
	    ...
	    "bytes>];I29[color=cyan3,shape=ellipse,label=<I29<br/><b>free</b> M2.A6<br/>B1 [0,0,0] - [1,1,1] <br/>4 "
	    "bytes>];I30[color=cyan3,shape=ellipse,label=<I30<br/><b>free</b> M3.A5<br/>B1 [1,0,0] - [2,1,1] <br/>4 "
	    "bytes>];I31[color=cyan3,shape=ellipse,label=<I31<br/><b>free</b> M1.A2<br/>B0 [0,0,0] - [1,1,1] <br/>4 "
	    "bytes>];I32[color=cyan3,shape=ellipse,label=<I32<br/><b>free</b> M2.A4<br/>B0 [0,0,0] - [1,1,1] <br/>4 "
	    "bytes>];I33[color=cyan3,shape=ellipse,label=<I33<br/><b>free</b> M3.A3<br/>B0 [0,0,0] - [1,1,1] <br/>4 "
