...
TEST_CASE("instruction-graph printing is unchanged", "[print_graph][instruction-graph]") {
	...
	const std::string expected =
	    ...
	    "<br/>8 bytes>];I17[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I17 (push C6)<br/><b>send</b> T2.B0.R1<br/>to N2 tag 10<br/>B0 [0,0,0] - "
	    "[1,1,1]<br/>via M0.A2 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 bytes>];I18[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I18 (push "
	    "C5)<br/><b>send</b> T2.B0.R1<br/>to N1 tag 11<br/>B0 [0,0,0] - [1,1,1]<br/>via M0.A2 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 "
	    ...
	    ">I28[];I11->I29[];I12->I30[];I26->I31[];I13->I32[];I14->I33[];I33->I34[];I32->I34[];I31->I34[];I30->I34[];I28->I34[];I27->I34[];I25->I34[];I29->I34[];"
	    "I16->I34[];P10[margin=0.2,shape=cds,color=\"#606060\",label=<<font color=\"#606060\"><b>pilot</b> to N2 tag 10<br/>T2.B0.R1<br/>for B0 [0,0,0] - "
	    "[1,1,1]</font>>];P10->I17[dir=none,style=dashed,color=\"#606060\"];P11[margin=0.2,shape=cds,color=\"#606060\",label=<<font "
	    "color=\"#606060\"><b>pilot</b> to N1 tag 11<br/>T2.B0.R1<br/>for B0 [0,0,0] - "
