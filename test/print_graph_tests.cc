...
TEST_CASE("instruction-graph printing is unchanged", "[print_graph][instruction-graph]") {
	...
	const std::string expected =
	    ...
	    "bytes>];I6[color=cyan3,shape=ellipse,label=<I6<br/>staging <b>alloc</b> M1.A2<br/>256%128 bytes>];I7[color=green3,shape=ellipse,label=<I7<br/>staging "
	    "<b>copy</b><br/>from M0.A2 ([0,0,0] - [4,1,1])<br/>to M1.A2 +0 bytes<br/>B1 {[2,0,0] - [3,1,1]} x4 "
	    "bytes>];I8[color=green3,shape=ellipse,label=<I8<br/>coherence <b>copy</b><br/>from M1.A2 +0 bytes<br/>to M2.A2 ([2,0,0] - [3,1,1])<br/>B1 {[2,0,0] - "
	    "[3,1,1]} x4 bytes>];I9[color=green3,shape=ellipse,label=<I9<br/>staging <b>copy</b><br/>from M0.A2 ([0,0,0] - [4,1,1])<br/>to M1.A2 +128 bytes<br/>B1 "
	    "{[3,0,0] - [4,1,1]} x4 bytes>];I10[color=green3,shape=ellipse,label=<I10<br/>coherence <b>copy</b><br/>from M1.A2 +128 bytes<br/>to M3.A2 ([3,0,0] - "
	    "[4,1,1])<br/>B1 {[3,0,0] - [4,1,1]} x4 bytes>];I11[color=cyan3,shape=ellipse,label=<I11<br/>gather <b>alloc</b> M1.A3<br/>for B0 [0,0,0] - [1,1,1] "
	    "x2<br/>8%4 bytes>];I12[color=darkorange2,shape=box,margin=0.2,style=rounded,label=<I12 (device-compute T1, execution C1)<br/><b>device "
	    "kernel</b><br/>on D0 [2,0,0] - [3,1,1]<br/>+ access B1 [2,0,0] - [3,1,1]<br/>via M2.A2 [0,0,0] - [1,1,1]<br/>+ (R1) reduce into B0 [0,0,0] - "
	    "[1,1,1]<br/>via M2.A1 [0,0,0] - [1,1,1]>];I13[color=darkorange2,shape=box,margin=0.2,style=rounded,label=<I13 (device-compute T1, execution "
	    "C1)<br/><b>device kernel</b><br/>on D1 [3,0,0] - [4,1,1]<br/>+ access B1 [3,0,0] - [4,1,1]<br/>via M3.A2 [0,0,0] - [1,1,1]<br/>+ (R1) reduce into B0 "
	    "[0,0,0] - [1,1,1]<br/>via M3.A1 [0,0,0] - [1,1,1]>];I14[color=green3,shape=ellipse,label=<I14<br/>gather <b>copy</b><br/>from M2.A1 ([0,0,0] - "
	    "[1,1,1])<br/>to M1.A3 +0 bytes<br/>B0 {[0,0,0] - [1,1,1]} x4 bytes>];I15[color=green3,shape=ellipse,label=<I15<br/>gather <b>copy</b><br/>from M3.A1 "
	    "([0,0,0] - [1,1,1])<br/>to M1.A3 +4 bytes<br/>B0 {[0,0,0] - [1,1,1]} x4 bytes>];I16[color=blue,shape=ellipse,label=<I16<br/>local <b>reduce</b> "
	    "B0.R1<br/>B0 [0,0,0] - [1,1,1]<br/>from M1.A3 x2<br/>to M1.A1 x1>];I17[color=cyan3,shape=ellipse,label=<I17<br/><b>free</b> M1.A3 <br/>8 "
	    "bytes>];I18[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I18 (push C2)<br/><b>send</b> T2.B0.R1<br/>to N0 MSG0<br/>B0 [0,0,0] - "
	    "[1,1,1]<br/>via M1.A1 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 bytes>];I19[color=cyan3,shape=ellipse,label=<I19<br/>buffer <b>alloc</b> M1.A4<br/>for B1 "
	    "[2,0,0] - [4,1,1]<br/>8%4 bytes>];I20[color=green3,shape=ellipse,label=<I20<br/>coherence <b>copy</b><br/>from M3.A2 ([3,0,0] - [4,1,1])<br/>to M1.A4 "
	    "([2,0,0] - [4,1,1])<br/>B1 {[3,0,0] - [4,1,1]} x4 bytes>];I21[color=green3,shape=ellipse,label=<I21<br/>coherence <b>copy</b><br/>from M2.A2 ([2,0,0] "
	    "- [3,1,1])<br/>to M1.A4 ([2,0,0] - [4,1,1])<br/>B1 {[2,0,0] - [3,1,1]} x4 bytes>];I22[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I22 "
	    "(push C3)<br/><b>send</b> T2.B1<br/>to N0 MSG1<br/>B1 [2,0,0] - [3,1,1]<br/>via M1.A4 [0,0,0] - [1,1,1]<br/>[1,1,1]x4 "
	    "bytes>];I23[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I23 (push C3)<br/><b>send</b> T2.B1<br/>to N0 MSG2<br/>B1 [3,0,0] - "
	    "[4,1,1]<br/>via M1.A4 [1,0,0] - [2,1,1]<br/>[1,1,1]x4 bytes>];I24[color=cyan3,shape=ellipse,label=<I24<br/>gather <b>alloc</b> M1.A5<br/>for B0 "
	    "[0,0,0] - [1,1,1] x2<br/>8%4 bytes>];I25[color=blue,shape=ellipse,label=<I25<br/><b>fill identity</b> for R1<br/>M1.A5 "
	    "x2>];I26[color=green3,shape=ellipse,label=<I26<br/>gather <b>copy</b><br/>from M1.A1 ([0,0,0] - [1,1,1])<br/>to M1.A5 +4 bytes<br/>B0 {[0,0,0] - "
	    "[1,1,1]} x4 bytes>];I27[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I27 (await-push C6)<br/><b>gather receive</b> T2.B0.R1<br/>B0 "
	    "[0,0,0] - [1,1,1] x2<br/>into M1.A5>];I28[color=blue,shape=box,margin=0.2,style=rounded,label=<I28 (reduction C5)<br/>global <b>reduce</b> "
	    "B0.R1<br/>B0 [0,0,0] - [1,1,1]<br/>from M1.A5 x2<br/>to M1.A1 x1>];I29[color=cyan3,shape=ellipse,label=<I29<br/><b>free</b> M1.A5 <br/>8 "
	    "bytes>];I30[color=cyan3,shape=ellipse,label=<I30<br/>buffer <b>alloc</b> M1.A6<br/>for B1 [0,0,0] - [2,1,1]<br/>8%4 "
	    "bytes>];I31[color=cyan3,shape=ellipse,label=<I31<br/>buffer <b>alloc</b> M2.A3<br/>for B1 [1,0,0] - [2,1,1]<br/>4%4 "
	    "bytes>];I32[color=cyan3,shape=ellipse,label=<I32<br/>buffer <b>alloc</b> M3.A3<br/>for B1 [0,0,0] - [1,1,1]<br/>4%4 "
	    ...
	    "[2,1,1]}<br/>into M1.A6 (B1 [0,0,0] - [2,1,1])<br/>x4 bytes>];I34[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I34 (await-push "
	    "C7)<br/><b>await receive</b> T2.B1<br/>B1 {[1,0,0] - [2,1,1]}>];I35[color=deeppink2,shape=box,margin=0.2,style=rounded,label=<I35 (await-push "
	    "C7)<br/><b>await receive</b> T2.B1<br/>B1 {[0,0,0] - [1,1,1]}>];I36[color=green3,shape=ellipse,label=<I36<br/>coherence <b>copy</b><br/>from M1.A6 "
	    "([0,0,0] - [2,1,1])<br/>to M3.A3 ([0,0,0] - [1,1,1])<br/>B1 {[0,0,0] - [1,1,1]} x4 bytes>];I37[color=green3,shape=ellipse,label=<I37<br/>coherence "
	    "<b>copy</b><br/>from M1.A6 ([0,0,0] - [2,1,1])<br/>to M2.A3 ([1,0,0] - [2,1,1])<br/>B1 {[1,0,0] - [2,1,1]} x4 "
	    "bytes>];I38[color=green3,shape=ellipse,label=<I38<br/>coherence <b>copy</b><br/>from M1.A1 ([0,0,0] - [1,1,1])<br/>to M3.A1 ([0,0,0] - "
	    "[1,1,1])<br/>B0 {[0,0,0] - [1,1,1]} x4 bytes>];I39[color=green3,shape=ellipse,label=<I39<br/>coherence <b>copy</b><br/>from M1.A1 ([0,0,0] - "
	    "[1,1,1])<br/>to M2.A1 ([0,0,0] - [1,1,1])<br/>B0 {[0,0,0] - [1,1,1]} x4 bytes>];I40[color=darkorange2,shape=box,margin=0.2,style=rounded,label=<I40 "
	    ...
	    "[1,1,1]}<br/>into M1.A7 (B2 [0,0,0] - [1,1,1])<br/>x4 bytes>];I46[color=darkorange2,shape=box,margin=0.2,style=rounded,label=<I46 (CG2 "
	    "collective-host T4, execution C9)<br/><b>host task</b><br/>on host [1,0,0] - [2,1,1]<br/>+ access B0 [0,0,0] - [1,1,1]<br/>via M1.A1 [0,0,0] - "
	    "[1,1,1]<br/>+ access B2 [0,0,0] - [1,1,1]<br/>via M1.A7 [0,0,0] - [1,1,1]>];I47[color=green3,shape=ellipse,label=<I47<br/>fence <b>copy</b><br/>from "
	    "M1.A1 ([0,0,0] - [1,1,1])<br/>to M0.A4 ([0,0,0] - [1,1,1])<br/>B0 {[0,0,0] - [1,1,1]} x4 "
	    "bytes>];I48[color=darkorange,shape=box,margin=0.2,style=rounded,label=<I48 (T5, C11)<br/><b>fence</b><br/>B0 [0,0,0] - "
	    ...
	    "orange];P0[margin=0.2,shape=cds,color=\"#606060\",label=<<font color=\"#606060\"><b>pilot</b> to N0 MSG0<br/>T2.B0.R1<br/>for B0 [0,0,0] - "
	    ...
	    "[3,1,1]</font>>];P1->I22[dir=none,style=dashed,color=\"#606060\"];P2[margin=0.2,shape=cds,color=\"#606060\",label=<<font "
