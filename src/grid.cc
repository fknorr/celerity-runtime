...
template void merge_adjacent_boxes(box_vector<0>& boxes);
template void merge_adjacent_boxes(box_vector<1>& boxes);
template void merge_adjacent_boxes(box_vector<2>& boxes);
template void merge_adjacent_boxes(box_vector<3>& boxes);
