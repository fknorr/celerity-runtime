...
void engine_impl::submit(const instruction* const instr) {
	CELERITY_DETAIL_TRACY_ZONE_SCOPED("out_of_order_engine::submit", Blue3, "submit");
...
void engine_impl::complete(const instruction* const instr) {
	CELERITY_DETAIL_TRACY_ZONE_SCOPED("out_of_order_engine::complete", Blue3, "complete");
...
std::optional<assignment> engine_impl::assign_one() {
	...
	CELERITY_DETAIL_TRACY_ZONE_SCOPED("out_of_order_engine::assign", Blue3, "assign");
